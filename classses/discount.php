...
class discount
{
    ...
    public function insertDiscount($data)
    {
        ...
        if ($coupon_name == ""  || $coupon_number == "" || $coupon_code == "" ) {
            $alert = "Vui lòng nhập đầy đủ thông tin";
            return $alert;
        } else {
           $sql = "INSERT INTO `tbl_discount`(`coupon_name`, `coupon_code`,`coupon_conditions`, `coupon_number`) 
           VALUES ('$coupon_name',' $coupon_code ',' $coupon_conditions','$coupon_number')";
