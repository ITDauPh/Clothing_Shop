            ...
            <div class="dash-cards">
                ...
                <div class="card-single">
                    ...
                    <div class="card-footer">
                        <a href="thongtinkh.php">View all</a>
                    </div>
                </div>
                <div class="card-single">
                    <div class="card-body">
                            ...
                            <form method="POST" action="">
                                <div class="activity-card-calendar">
                                        ...
                                        <div class="input-group mb-3">
                                            <input id="datePickerId" value="2023-01-01" name="date1" type="date" data-date-inline-picker="true" />
                                        </div>
                                        <div class="input-group mb-3">
                                            <input id="datePickerId" value="2023-12-30" name="date2" type="date" data-date-inline-picker="true" />
                                        </div>
